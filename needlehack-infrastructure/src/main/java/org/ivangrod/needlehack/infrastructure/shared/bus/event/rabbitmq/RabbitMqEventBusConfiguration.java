...
import org.ivangrod.needlehack.infrastructure.shared.bus.event.DomainEventSubscribersInformation;
import org.ivangrod.needlehack.infrastructure.shared.bus.event.DomainEventsInformation;
...
public class RabbitMqEventBusConfiguration {
  ...
  public Declarables declaration() {
    ...
    TopicExchange deadLetterDomainEventsExchange = new TopicExchange(deadLetterExchangeName, true,
        false);
