...
import org.ivangrod.needlehack.infrastructure.shared.bus.event.DomainEventJsonDeserializer;
...
public final class RabbitMqDomainEventsConsumer {
  ...
  private Object subscriberFor(String queue) throws Exception {
    ...
    String subscriberName = StringFormatter.toCamelFirstLower(queueParts[queueParts.length - 1]);
