...
public class PostCreated extends DomainEvent {
    ...
    public PostCreated(String aggregateId, String eventId, LocalDateTime happenedAt, String title, String uri, LocalDateTime publicatedAt) {
    ...
    public HashMap<String, Serializable> toPrimitives() {
        return new HashMap<>() {{
            put("title", title);
            put("uri", uri);
            put("publicatedAt", publicatedAt);
        }};
    }

    @Override
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body, String eventId, LocalDateTime happenedAt) {
